...
namespace SAML2.Profiles.DKSAML20.Tests
{
    /// <summary>
    ...
    public class DKSaml20ProfileValidationTest
    {
        ...
        {
            Saml20Assertion assertion = AssertionUtil.DeserializeToken(@"Assertions\Saml2Assertion_01", false);
        ...
        public void AttributeStatement_Invalid_EncryptedAttribute_DKSaml20()
        {
            ...
            new Saml20Assertion(doc.DocumentElement, null, SAML20FederationConfig.GetConfig().AssertionProfile.AssertionValidator, false);
        }
        ...
        public void AttributeStatement_Invalid_Statementtype()
        {
            ...
            new Saml20Assertion(AssertionUtil.ConvertAssertion(saml20Assertion).DocumentElement, null, SAML20FederationConfig.GetConfig().AssertionProfile.AssertionValidator, false);
        }
