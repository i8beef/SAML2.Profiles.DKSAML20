param(
	[string]$project = ".\src\SAML2.Profiles.DKSAML20\SAML2.Profiles.DKSAML20.csproj",
	[string]$solution = ".\src\SAML2.Profiles.DKSAML20.sln",
	[string]$assemblyInfoFile = ".\src\SAML2.Profiles.DKSAML20\Properties\AssemblyInfo.cs",
	[string]$nuspecFile = ".\src\SAML2.Profiles.DKSAML20\SAML2.Profiles.DKSAML20.nuspec"
)
